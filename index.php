       ...
       <img class="img-responsive" src="images/home_banner.jpg" style="width:100%; height:180px;">      
        ...
        <div class="row" style="color: #ffbb2b">
            <div class="col-md-4 wellfix">
             <!-- <br> <h4><strong>Contact Us</strong></h4><hr>
              Address : Northsouth University<br>
              Mail : admin@northsouth.edu  -->
            </div>
            ...
            <div class="col-md-4 wellfix">
				...
				<a href="https://www.facebook.com/saiflovesyou1994">facebook</a>
